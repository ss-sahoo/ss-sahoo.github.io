  ...
  return (
    ...
    >
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            className="relative z-0 ml-20 before:absolute before:-top-4 before:left-[2rem] before:rounded-t-[400px]
            before:w-full before:max-w-[400px] md:before:max-w-[450px] md:before:max-h-[500px] before:h-full before:border-2 before:border-blue before:z-[-1]"
          >
            <img
              alt="profile"
